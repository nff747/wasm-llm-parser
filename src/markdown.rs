...
mod tests {
    ...
    #[test]
    #[test]
    fn test_strip_custom_tag_32() {
        assert_eq!(strip_custom_tag_32("<tag32>text</tag32>"), "text");
    }

    #[test]
    #[test]
    fn test_strip_custom_tag_33() {
        assert_eq!(strip_custom_tag_33("<tag33>text</tag33>"), "text");
    }

    #[test]
    #[test]
    fn test_strip_custom_tag_34() {
        assert_eq!(strip_custom_tag_34("<tag34>text</tag34>"), "text");
    }
...
pub fn strip_custom_tag_32(input: &str) -> String {
    input.replace("<tag32>", "").replace("</tag32>", "")
}

pub fn strip_custom_tag_33(input: &str) -> String {
    input.replace("<tag33>", "").replace("</tag33>", "")
}

pub fn strip_custom_tag_34(input: &str) -> String {
    input.replace("<tag34>", "").replace("</tag34>", "")
}
